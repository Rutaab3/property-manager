...
export default function Properties() {
  ...
  const PropertyForm = () => (
    <div className="space-y-4">
      ...
      <div><label className="text-sm font-medium">Photo URL</label><Input value={form.photoUrl} onChange={e => setForm({ ...form, photoUrl: e.target.value })} placeholder="https://..." /></div>
    </div>
  );
